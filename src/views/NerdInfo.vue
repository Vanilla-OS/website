    ...
    <div class="flexList anim--fadeIn">
        <div class="text text--rich">
            <p>Vanilla OS is not your regular Linux distribution, we define it as a Linux based operating system
                due to the new paradigms it introduces and the different standards it follows. Here we list what
                Vanilla OS is and how it is different from other Linux distributions.</p>
        </div>
            ...
            info: [
                {
                    ...
                    a set of different instructions, such as a package, a build script, a configuration file, etc.\
                    This approach allows us to build a system that is more flexible and easier to maintain, while\
                    keeping a Debian compatible system. In Vanilla OS we don\'t care about dependencies like other\
                    distributions do, since the system is immutable and updates are served as a whole.',
                ...
                },
                {
                    icon: 'lock',
                    title: 'Immutable',
                    description: 'Vanilla OS is an immutable operating system, which means the main system components are\
                ...
                },
                {
                    ...
                    While common distributions use a package manager to handle updates, Vanilla OS uses a\
                ...
                },
                {
                    icon: 'lightbulb',
                    title: 'Smart Updates',
                    description: 'Vanilla OS performs background smart updates, which means that the system is updated\
                    only when it is not under heavy load. This allows us to keep the system always\
                    updated, without affecting the user experience. To achieve so, we check for multiple\
                    conditions, such as the system load, the battery level, the network connection, etc.',
                },
                {
                    icon: 'storage',
                    title: 'Different File System Hierarchy',
                    description: 'Vanilla OS features a particular File System Hierarchy, even remaining compatible with\
                    the FHS standard. The main difference is that Vanilla OS stores the system files in a different\
                    directory, which is /.system, this due to how ABRoot, the technology we use to provide immutability\
                ...
                },
                {
                    ...
                    VSO, which is the user conainer-based default shell, or Apx, a power utility for developers (and\
                    not only) to create system-integrated containers based on any Linux distribution, and many more.\
                    We use containers to provide a more secure and reliable system, and to make the system more\
                    flexible and customizable for every need.',
                },
                {
                    icon: 'memory',
                ...
                },
                {
                    ...
                    it allows the user to manage the system in many ways, as well as installing Android applications\
                ...
                },
                {
                    icon: 'key',
                    title: 'Sudon\'t',
                    description: 'Vanilla OS diverges from the conventional use of sudo and, instead, employs Polkit for\
                    enhanced security and flexibility in permission management. Polkit enables a more granular approach\
                ...
                },
                {
                    ...
                    called FsGuard, which verifies system integrity at boot, checking that the hashes of crucial system files\
                    are those provided with the update image. If one of these is missing, FsNotice will come into play, showing\
