...
<div class="hero hero-center">
    <div class="container hero-wrapper">
        <div class="hero-text">
            ...
            <p>Vanilla OS is an <span class="mark">immutable</span> and <span class="mark">atomic</span> Ubuntu-based Point Release distribution that receives updates at the right time without sacrificing security and functionality.</p>
        </div>
    </div>
</div>
