<template>
    ...
    <div class="hero-wrapper container">
      ...
      <article class="hero-content">
        ...
        <div class="hero-footer">
          <div class="flexList">
            <router-link
              :to="{ name: 'download-reunion-stable' }"
  ...
  <section class="hero hero--inverted hero--big" id="work">
    <div class="hero-wrapper container">
      <img
        ...
        src="/assets/images/backgrounds/rnote.svg"
      ...
      <article class="hero-content">
        ...
        <div class="flexList">
          <div class="text text--spaced">
            <p>
              Vanilla OS is designed to be a reliable and productive operating
              system for your daily work.
            </p>
            <p>
              The desktop environment is perfect for your daily tasks, thanks to
              its clean and intuitive interface. Everything is setup so that you
              can start working, and focus on what matters.
            </p>
            <p>
              Vanilla OS is ready to meet your needs whether you are a
              developer, designer, or student, thanks to a wide range of apps.
            </p>
          </div>
        </div>
      </article>
  ...
  <section
    class="hero hero--big hero--bg-center hero--extra-margin"
    id="access"
  >
    <article class="hero-wrapper container">
      <img
        class="hero-image onFocus"
        data-focus-class="fadeIn"
        src="/assets/images/backgrounds/apps-overview.png"
      ...
      <article class="hero-content">
        ...
        <div class="flexList">
          <div class="text text--spaced">
            ...
            <a
              href="https://vib.vanillaos.org/"
              target="_blank"
              rel="noopener noreferrer"
              class="btn btn--link btn--link-2 btn--inline"
            >
              <span>Learn more about Vib</span>
  ...
  <section class="container">
    <div class="hero hero--vertical hero--allow-scroll">
      ...
      <button @click="toggleInfo" class="btn btn--primary">
        <span class="material-symbols-outlined" v-if="!showInfo"
  ...
  <section class="container">
    ...
    <div class="flexGrid flexGrid--3">
      ...
      >
        <btn-adv v-if="item.type === 'adv'" :icon="item" :link="item">{{
          item.btn
        }}</btn-adv>
      </card>
    </div>
    ...
    return {
      ...
      info: [
        ...
        },
        {
          ...
          description:
            "Vanilla OS is designed to be easy to understand, you don't need to be a\
      ...
      medias: [
        ...
        },
        {
          ...
          description:
            "Help us spread the word about Vanilla OS and its features.",
          btn: "Read more",
          extraClasses: ["card--yellow"],
        },
      ],
    };
  },
    ...
    onMounted(() => {
      ...
      if (
        ...
        window.addEventListener("scroll", () => {
          ...
          if (scrollTop > 100) {
            wrapper.style.opacity = Math.max(
              0,
              1 - (scrollTop - 100) / 200,
            ).toString();
          } else {
