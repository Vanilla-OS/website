<template>
    <div class="flexList anim--fadeIn">
        <div class="text text--rich">
            <p>Vanilla OS is an Open Source project that is maintained by <a href="//fabricators.ltd">fabricators.ltd</a>
                and a team of volunteers. We are a diverse group of people from all over the world, with a wide range of
        ...
        <div class="text text--rich">
            <p>There are many more people who have contributed to Vanilla OS. A full list of contributors can be
