    ...
    <bento>
        <template #content>
            <bento-card class="Bento-card Bento-card--2" background="/assets/images/bento/bento-1/top-left.svg"
                ...
                <template #title>{{$t('testing-components.cards[3].title1')}} <u style="color: #FFFB64">{{$t('testing-components.cards[3].title2')}}</u></template>
            </bento-card>
            <bento-card class="Bento-card Bento-card--5" background="/assets/images/bento/bento-1/top-right.svg"
                ...
                <template #content>{{$t('testing-components.cards[4].description')}}</template>
            </bento-card>
            <bento-card class="Bento-card Bento-card--3" background="/assets/images/bento/bento-1/bottom-left.svg"
                ...
                <template #content>{{$t('testing-components.cards[5].description')}}</template>
            </bento-card>
...
export default defineComponent({
    name: "bento-orchid-release",
    data() {
        return {
            pages: [
                {
                    title: this.$t('testing-components.cards[6].carousel.title'),
