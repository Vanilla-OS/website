...
<div class="hero hero-center">
    <div class="container hero-wrapper">
        <div class="hero-text">
            ...
            <p>Vanilla OS is an <span class="mark">immutable</span> and <span class="mark">atomic</span> Debian-based distribution that receives updates at the right time without sacrificing security or functionality.</p>
        </div>
    </div>
</div>
    ...
    <div class="container hero-wrapper">
        <div class="hero-text">
            ...
            <div class="accordion">
                ...
                {% capture answer %}
                    <p>Vanilla OS aims to be a stable and compatible distribution, and Debian is a distribution that respects our design philosophies.</p>
